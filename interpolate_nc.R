#' @title Interpolate raster to a finer resolution
#' @description  Take anomaly nc file from ScenarioMIP CMIP6
#' @details INPUT: 1) Anomaly files for 2 periods 2020-2050, 2070-21002
#' @details OUTPUT: 1) Interpolated files
...
InterpolateData <- function(this.file,PugetSoundRaster,data.path,save.path)
{
  ...
  #this.file<-"sos_Omon_CNRM-CM6-1-HR_ssp126_r1i1p1f2_anomaly_202001-205012.nc"
